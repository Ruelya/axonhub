...
var (
	...
	RequestsColumns = []*schema.Column{
		...
		{Name: "client_profile", Type: field.TypeString, Nullable: true, Default: ""},
		{Name: "client_detect_source", Type: field.TypeString, Nullable: true, Default: ""},
		{Name: "client_compat_applied", Type: field.TypeBool, Default: false},
