...
func (_m *Request) Node(ctx context.Context) (node *Node, err error) {
	...
	if buf, err = json.Marshal(_m.ClientProfile); err != nil {
		return nil, err
	}
	node.Fields[19] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(_m.ClientDetectSource); err != nil {
		return nil, err
	}
	node.Fields[20] = &Field{
		Type:  "string",
		Name:  "client_detect_source",
		Value: string(buf),
	}
	if buf, err = json.Marshal(_m.ClientCompatApplied); err != nil {
		return nil, err
	}
	node.Fields[21] = &Field{
		Type:  "bool",
		Name:  "client_compat_applied",
		Value: string(buf),
	}
